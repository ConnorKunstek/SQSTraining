...
<div class="container">
		<div class="container">
			<form class="form-horizontal" id="saveProfileForm" action="profile_controller.php" method="post" enctype="multipart/form-data">
				...
				<div class="progress">
                    <div id="userProg" class="progress-bar  progress-bar-striped  bg-success" style="width:<?php getProgress()?>" role="progressbar" aria-valuenow="<?php echo getProgress() ?>" aria-valuemin="0" aria-valuemax="100">
